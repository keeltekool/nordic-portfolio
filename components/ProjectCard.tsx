...
export function ProjectCard({ project }: ProjectCardProps) {
  ...
  return (
    <div className="h-full flex flex-col rounded-lg border border-[var(--border)] bg-[var(--card)] hover:bg-[var(--card-hover)] transition-colors overflow-hidden">
      {project.image && (
        <a
          href={project.url}
          target="_blank"
      ...
      <div className="flex flex-col flex-grow p-5 border-t-2 border-[var(--border)]">
